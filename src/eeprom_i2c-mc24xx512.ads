-----------------------------------------------------------------------------
--  Concrete implementation class for the MicroChip 24XX512 EEPROM
--
...
package EEPROM_I2C.MC24XX512 is
   ...
   is new EEPROM_Memory (
                         ...
                         C_Max_Byte_Address => 65_535, --  Size in Bytes - 1
                         C_Write_Delay_MS => 5,
