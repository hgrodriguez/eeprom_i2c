-----------------------------------------------------------------------------
--  Concrete implementation class for the MicroChip 24XX1024 EEPROM
--
...
package EEPROM_I2C.MC24XX1024 is
   ...
   is new EEPROM_Memory (
                         C_Type_of_Chip => EEC_MC24XX1024,
                         C_Memory_Address_Size => HAL.I2C.Memory_Size_16b,
                         C_Size_In_Bytes => 131_072,
                         C_Size_In_Bits => 1_048_576,
                         C_Number_Of_Blocks => 2,
                         C_Bytes_Per_Block => 65_536,
                         C_Number_Of_Pages => 1_024,
                         C_Bytes_Per_Page => 128,
                         C_Max_Byte_Address => 131_071, --  Size in Bytes - 1
                         C_Write_Delay_MS => 5,
